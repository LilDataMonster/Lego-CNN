...
from detector.mrcnn.config import Config
from detector.mrcnn import model as modellib, utils
...
#         coco = COCO("{}/annotations/instances_{}{}.json".format(dataset_dir, subset, year))
        coco = COCO(f"{dataset_dir}/coco_annotations.json")
...
#                 path=os.path.join(image_dir, coco.imgs[i]['file_name']),
    ...
    def load_mask(self, image_id):
        ...
        if image_info["source"] != "coco":
            return super(LegoDataset, self).load_mask(image_id)
    ...
    def image_reference(self, image_id):
        ...
        if info["source"] == "coco":
            ...
            super(LegoDataset, self).image_reference(image_id)
...
if __name__ == '__main__':
    ...
    model.load_weights(model_path, by_name=True, exclude=["mrcnn_class_logits", "mrcnn_bbox_fc", "mrcnn_bbox", "mrcnn_mask", "rpn_model", "anchors"])
